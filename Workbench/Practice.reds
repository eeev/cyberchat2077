module CyberChat.Workbench
import Codeware.Localization.*
import Codeware.UI.*

/*

	The Practice class does the following:
		- As a superclass of UI elements, it receives and shows UI hints
		- UI hints are displayed beneath the workbench and indicate interactions with UI elements (e.g., 'left click' on a button)
